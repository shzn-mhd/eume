...
const FormAccommodationAdd = ({ accommodation, closeModal }) => {
  ...
  const [avatar, setAvatar] = useState(
    getImageUrl(
      `avatar-${
        accommodation && accommodation !== null && accommodation?.avatar
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      ...
      try {
        ...
        if (accommodation) {
          dispatch(
            updateAccommodation(accommodation._id, newAccommodation,image)
          ).then(() => {
            openSnackbar({
              open: true,
          ...
          dispatch(createAccommodation(values,image)).then(() => {
            openSnackbar({
              open: true,
      ...
      <FormikProvider value={formik}>
        <LocalizationProvider dateAdapter={AdapterDateFns}>
          <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
            <DialogTitle>
              {accommodation ? "Edit Hotel" : "New Hotel"}
            </DialogTitle>
            <Divider />
              ...
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <Stack spacing={1} sx={{ pt: 1 }}>
                        <InputLabel htmlFor="numberOfRooms">
                          Number of Rooms
                        </InputLabel>
                        <TextField
                          fullWidth
