...
function createData(name, calories, fat, carbs, protein, sample) {
  return { name, calories, fat, carbs, protein, sample };
}
...
const AvgSurvayByMunicipilityWidg = () => {
  ...
  return (
    <TableContainer component={Paper} sx={{ width: '100%' }}>
      <Table sx={{ minWidth: 650, width: '100%' }} aria-label="municipility avg data">
        <TableHead>
          <TableRow>
            <TableCell></TableCell>
